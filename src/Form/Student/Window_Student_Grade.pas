...
procedure TStudent_Grade.BitBtn_LogoutClick(Sender: TObject);
begin
...
procedure TStudent_Grade.BitBtn_Menu1Click(Sender: TObject);
begin
  self.Hide;
  links.Student_Main.Show;
end;

procedure TStudent_Grade.BitBtn_Menu2Click(Sender: TObject);
begin
...
procedure TStudent_Grade.BitBtn_Menu3Click(Sender: TObject);
begin
...
procedure TStudent_Grade.BitBtn_Menu4Click(Sender: TObject);
begin
...
procedure TStudent_Grade.BitBtn_Menu5Click(Sender: TObject);
begin
