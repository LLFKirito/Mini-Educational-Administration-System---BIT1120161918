unit Window_Administrator_ModStu;
...
type
  TAdministrator_ModStu = class(TForm)
...
var
  Administrator_ModStu: TAdministrator_ModStu;
...
procedure TAdministrator_ModStu.BitBtn1Click(Sender: TObject);
begin
  DataModule1.ADOQuery2.SQL.Text := 'select * from AccountStudent where UserName = :ID;';
  ...
  DataModule1.ADOQuery2.SQL.Text := 'update AccountStudent set Cipher = :Ci where UserName = :ID;';
  DataModule1.ADOQuery2.Parameters.ParamByName('ID').Value := Edit1.Text;
...
procedure TAdministrator_ModStu.BitBtn_LogoutClick(Sender: TObject);
begin
...
procedure TAdministrator_ModStu.BitBtn_Menu1Click(Sender: TObject);
begin
  self.Hide;
  links.Administrator_Main.Show;
end;

procedure TAdministrator_ModStu.BitBtn_Menu2Click(Sender: TObject);
begin
...
procedure TAdministrator_ModStu.BitBtn_Menu3Click(Sender: TObject);
begin
...
procedure TAdministrator_ModStu.BitBtn_Menu4Click(Sender: TObject);
begin
...
procedure TAdministrator_ModStu.BitBtn_Menu5Click(Sender: TObject);
begin
