unit Window_Administrator_AddTea;
...
type
  TAdministrator_AddTea = class(TForm)
...
var
  Administrator_AddTea: TAdministrator_AddTea;
...
procedure TAdministrator_AddTea.BitBtn_ChangeClick(Sender: TObject);
var
  Name : String;
  ID : String;
...
begin
  ...
  DataModule1.ADOQuery2.SQL.Text := 'select * from Teacher where TeacherNo = :ID;';
  ...
  DataModule1.ADOQuery1.SQL.Text := 'insert into Teacher values(:No,:Na,:Co,:Ge,:Ti,:De,:Major,:Po,:Nat,:Tel,:Mail);';
  ...
  DataModule1.ADOQuery1.Parameters.ParamByName('Ti').Value := Title;
  DataModule1.ADOQuery1.Parameters.ParamByName('De').Value := Degree;
  DataModule1.ADOQuery1.Parameters.ParamByName('Major').Value := Major;
  ...
  DataModule1.ADOQuery1.SQL.Text := 'insert into AccountTecher values(:No,:Ci);';
  DataModule1.ADOQuery1.Parameters.ParamByName('No').Value := ID;
...
procedure TAdministrator_AddTea.BitBtn_LogoutClick(Sender: TObject);
begin
...
procedure TAdministrator_AddTea.BitBtn_Menu1Click(Sender: TObject);
begin
  self.Hide;
  links.Administrator_Main.Show;
end;

procedure TAdministrator_AddTea.BitBtn_Menu2Click(Sender: TObject);
begin
...
procedure TAdministrator_AddTea.BitBtn_Menu3Click(Sender: TObject);
begin
  Administrator_AddTea.Edit1.Text;
  Administrator_AddTea.Edit2.Text;
  Administrator_AddTea.ComboBox1.ItemIndex := -1;
...
procedure TAdministrator_AddTea.BitBtn_Menu4Click(Sender: TObject);
begin
...
procedure TAdministrator_AddTea.BitBtn_Menu5Click(Sender: TObject);
begin
